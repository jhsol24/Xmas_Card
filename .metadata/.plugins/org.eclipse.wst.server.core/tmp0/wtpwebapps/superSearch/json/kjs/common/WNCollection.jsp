...
<%!
	...
	static String SEARCH_IP="101.101.210.156";
	static int SEARCH_PORT=7000;
	static String MANAGER_IP="101.101.210.156";
	static int MANAGER_PORT=7800;

	public String[] COLLECTIONS = new String[]{"doc","dctn"};
	public String[] COLLECTIONS_NAME = new String[]{"doc","dctn"};
