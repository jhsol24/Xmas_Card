...
${colList}
    <div class="wrap">
        ...
        <div class="header">
			...
			<input type="hidden" name="sort" value="ㄷㄷㄷ" />
			<input type="hidden" name="collection" value="ㅇㅇ" />
			<input type="hidden" name="range" value="333" />
			<input type="hidden" name="startDate" value="ㄷㄷㄷ" />
			<input type="hidden" name="endDate" value= "323"/>			
			<input type="hidden" name="searchField"value="ㅇㅇㅇ" />
			<input type="hidden" name="reQuery" />
			<input type="hidden" name="realQuery" value="ㅁㅁㅁㅁ" />
