...
(function($) {
    ...
    $.ownage.Loader = function(el, params, selector, number) {
        ...
        base.preloadImages = function() {
            var images = [
                '/resources/jquery-oLoader-v0.1/images/ownageLoader/loader1.gif',
                '/resources/jquery-oLoader-v0.1/images/ownageLoader/loader2.gif',
                '/resources/jquery-oLoader-v0.1/images/ownageLoader/loader3.gif',
                '/resources/jquery-oLoader-v0.1/images/ownageLoader/loader4.gif',
                '/resources/jquery-oLoader-v0.1/images/ownageLoader/loader5.gif',
                '/resources/jquery-oLoader-v0.1/images/ownageLoader/loader6.gif',
                '/resources/jquery-oLoader-v0.1/images/ownageLoader/loader7.gif'
            ];
    ...
    $.ownage.Loader.defaultOptions = {
        image: '/resources/jquery-oLoader-v0.1/images/ownageLoader/loader1.gif',
        style: 1,
        context: 'body',
        modal: true,
        fadeInTime: 300,
