...
public class WNSearch {
	...
	public String getPageLinks(int startCount, int totalCount, int viewListCount, int bundleCount) {
		...
		sbRet.append("<div class=\"paging2 clearfix\">");
		...
		if(wnanchor.getCurPageNumber() > 1 ){
			...
			sbRet.append("<a class=\"img prev1\" href=\"#none\" onclick=\"javascript:pagingProcessing('"+0+"');\" title=\"첫 페이지\">&lt;&lt;</a>");
		} else {
			//sbRet.append("<a href=\"#none\" title=\"첫페이지\"><img src=\"\" alt=\"맨처음\"></a> ");
			sbRet.append("<a class=\"img prev1\" href=\"#none\" title=\"첫 페이지\">&lt;&lt;</a>");
		}
		...
		if((wnanchor.getCurPageNumber() -1 )/10 > 0){
			...
			sbRet.append("<a class=\"img prev2\" href=\"#none\" onclick=\"javascript:pagingProcessing('"+( ((wnanchor.getCurPageNumber()-1)/10-1) *100 )+"');\" title=\"이전 페이지\">&lt;</a>");
		} else {
			//sbRet.append("<a class=\"img\" href=\"#none\" class=\"img\"><img src=\"/images/ggc/search/s_prev.gif\" alt=\"이전\"></a> ");
			sbRet.append("<a class=\"img prev2\" href=\"#none\" title=\"이전 페이지\">&lt;</a>");
		}
		...
		for(int i=0; i<pageCount && i < pages.length; i++) {
			if(pages[i][1].equals("-1")) {
				sbRet.append("<a class=\"on\" href=\"#none\" title=\"현재 페이지\"> "+pages[i][0]+" </a>");
			} else {
		...
		if( wnanchor.getTotalPgCount() != wnanchor.getCurPageNumber()
			...
			sbRet.append("<a class=\"img next2\" href=\"#none\" onclick=\"javascript:pagingProcessing('" + ((wnanchor.getCurPageNumber()-1)/10 == 0 ? 1*100 : ((wnanchor.getCurPageNumber()-1)/10 +1)*100) + "');\" title=\"다음 페이지\">&gt;</a>");
		} else {
			//sbRet.append("<a href=\"#none\" class=\"img\"><img src=\"/images/ggc/search/s_next.gif\" alt=\"다음\"></a> ");
			sbRet.append("<a class=\"img next2\" href=\"#none\" title=\"다음 페이지\">&gt;</a> ");
		}
		...
		if(wnanchor.getCurPageNumber() < wnanchor.getTotalPgCount()) {
			...
			sbRet.append("<a class=\"img next1\" href=\"#none\" onclick=\"javascript:pagingProcessing('"+(wnanchor.getTotalPgCount()-1)*10+"')\" title=\"마지막 페이지\">&gt;&gt;</a>");
		} else {
			//sbRet.append("<a class=\"img\" href=\"#none\" title=\"마지막페이지\"><img src=\"/images/ggc/search/s_last.gif\" alt=\"마지막\"></a>");
			sbRet.append("<a class=\"img next1\" href=\"#none\" title=\"마지막 페이지\">&gt;&gt;</a>");
		}
