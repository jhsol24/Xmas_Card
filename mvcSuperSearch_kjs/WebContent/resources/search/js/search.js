...
function showMyKeyword(myKeywords) {
	...
	for( var i = 0; i < myKeywords.length; i++) {
		...
		str += "<li class=\"searchkey\"><a class=\"btn_close\" href=\"#none\" onClick=\"javascript:doKeyword('"+myKeywords[i]+"');\">"+myKeywords[i]+"</a> <img src=\"images/icon_close.gif\" onClick=\"removeMyKeyword('"+myKeywords[i]+"');\"/></li>";
	}
...
// 컬렉션별 검색
function doCollection(coll,moresee) {
	var searchForm = document.search; 
...
function doPaging(count) {
	alert("또잉");
	var search_result_dctn_Form=document.search_result_dctn; 
	var search_result_doc_Form=document.search_result_doc; 
	var searchForm = document.search;
	
	searchForm.startCount.value = count;
	if(search_result_dctn_Form.collection.value == 'dctn'){
	alert("진입1");
	searchForm.collection.value = search_result_dctn_Form.collection.value;
	
	}else if(search_result_doc_Form.collection.value == 'doc'){
	alert("진입2");
	searchForm.collection.value = search_result_doc_Form.collection.value;
