<%@ page import="java.io.*,java.lang.*,java.net.*,java.util.*"%><%@ page contentType="text/xml; charset=UTF-8" language="java" session="false" %><%request.setCharacterEncoding("utf-8");%><%@ include file="../common/WNCollection.jsp" %><%
    ...
    **/
	...
	String url = "http://" + MANAGER_IP + ":" + MANAGER_PORT + "/manager/WNRun.do?query=&target=popword&range=d&collection=POP&datatype=json";
	/* http://118.67.131.213:7800/manager/WNRun.do?query=&target=popword&range=d&collection=POP&datatype=json
	*/
