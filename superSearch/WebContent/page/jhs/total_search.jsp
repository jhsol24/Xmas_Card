        ...
        <div class="header">
            ...
            <div class="top clearfix">
				...
				<div class="sch_wrap">
                    ...
                    <a href="#" onClick="javascript:doSearch();" title="검색" class="btn_sch"></a>
				</div>
				<a href="#" class="detail_btn">상세검색</a>
				<div class="sch_opt">
					<input type="checkbox" id="result_chk" checked="checked" />
					<label for="result_chk"><input name="reChk" id="reChk" onClick="checkReSearch();" type="checkbox" /><span></span>결과 내 재검색</label>
				</div>
